        ...
        <div className="profile-page">
            <div className="profile-container">
                ...
                <div className="profile-header">
                    ...
                    <div className="profile-info">
                        ...
                        <div className="member-since">
                            Member Since {userProfile?.createdAt?.toDate()?.toLocalDateString() || 'Recently'}
                        </div>
                    </div>
                </div>
                ...
                <div className="mood-preferences">
                    ...
                    <p>Rate now, how much you enjoy each mood category (1-5 Stars)</p>
                ...
                <div className="recent-activity">
                    ...
                    {Object.keys(userVotes).length > 0 ? (
                        ...
                        <div className="no-activity">
                            <p>No activity yet, Start discovering video to see your activity here</p>
                        </div>                   
                    )}
                </div>
            </div>
