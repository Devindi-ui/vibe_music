...
const videoCard = ({ video, onVote, userVote, selectMood }) => {
    ...
    const formatDuration = (duration) => {
        ...
        return `${minutes}:${seconds.toString().padString(2,'0')}`;
    };
    ...
    const formatPublishDate = (dateString) => {
        ...
        if(diffDays < 30) return `${Math.cell(diffDays / 7)} weeks ago`
        if(diffDays < 365) return `${Math.cell(diffDays / 30)} months ago`
        return `${Math.cell(diffDays / 365)} years ago`
    }
            ...
            <div className="video-actions">
                <div className="vote-buttons">
                    ...
                    <button
                        ...
                        title="This doesn't matches the vibe!!"
                    >
